...
##### Oreol Engineering	*(December 2012 Р December 2017)*
Saint-Petersburg, Russia.
*Software technical support*

##### Qulix Systems	*(May 2011 Р July 2012)*
Minsk, Belarus.
`Project: MP`
...
##### JSC Mostovdrev	*(August 2008  Р August 2010)*
Mosty, Belarus.
`Project: The system for registration, storage, recording of passes.   `
The system is a client-based application for creation, editing, deletion of passes for the enterprise. And also the back-end for data storage in database.
...
##### Scanwest	*(August 2007 Р July 2008)*
Minsk, Belarus.
...
Technical documentation translation and testing of localized part of the interface (Russification of Nemetschek end-to-end solution in architectural projecting and building) 
